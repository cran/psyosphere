...
des_sd <- function(
  ...
  # Calculate sd for each track
  result <- psyosphere::apply_tracks(
    tracks,
    "sd_private(eval_track, arg1, arg2, arg3, arg4, arg5)",
    arg1 = ctarget,
    arg2 = cweight,
    arg3 = cgaps,
    arg4 = cname,
...
sd_private <- function(tracks, ctarget, cweight, cgaps, cname, t_id) {
  ...
  # Calculate normal sd
  if (cweight == "") {
    result <- stats::sd( tracks[,ctarget], na.rm = TRUE)
  }
